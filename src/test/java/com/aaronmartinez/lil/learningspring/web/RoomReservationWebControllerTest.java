...
// pass our actual controller to this annotation.
@WebMvcTest(RoomReservationWebController.class)
public class RoomReservationWebControllerTest {
    // allows us to use Mockito with Spring tests to generate mock instance of dependency
    @MockBean
    ...
    public void getReservations() throws Exception {
        ...
        roomReservation.setLastName("Martinez");
        roomReservation.setFirstName("Aaron");
        ...
        this.mockMvc.perform(get("/reservations?date=2020-01-01"))
                ...
                .andExpect(content().string(containsString("Martinez, Aaron")));
    }
}